...
channel.queue_bind(queue='email_notify', exchange='sys_activity', routing_key='email_notify')
channel.queue_bind(queue='gen_thumbnails', exchange='sys_activity', routing_key='gen_thumbnails')
channel.queue_bind(queue='update_file_system', exchange='sys_activity', routing_key='update_file_system')
